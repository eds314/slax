defmodule SlaxWeb.ChatRoomLive do
  ...
  def render(assigns) do
    ...
    <div class="flex flex-col flex-shrink-0 w-64 bg-slate-100">
      ...
      <div class="mt-4 overflow-auto">
        ...
        <.toggler on_click={toggle_rooms()} dom_id="rooms-toggler" text="Rooms" />        </div>
        <div id="rooms-list">
        <.room_link
        ...
        <div class="mt-4">
          <div class="flex items-center h-8 px-3 group">
            ...
            <.toggler on_click={toggle_users()} dom_id="users-toggler" text="Users" />            </div>
          </div>
          <div id="users-list">
            <.user
              :for={user <- @users}
    ...
    <div class="flex flex-col flex-grow shadow-lg">
      <div class="flex flex-col flex-grow shadow-lg">
        <div class="flex justify-between items-center flex-shrink-0 h-16 bg-white border-b border-slate-00 px-4">
          <div class="flex flex-col gap-1.5">
  ...
  defp message(assigns) do
    ...
    <div id={@dom_id} class="group relative flex px-4 py-3">
      ...
      <img class="h-10 w-10 rounded flex-shrink-0" src={~p"/images/one_ring.jpg"} />      <div class="ml-2">
        <div class="-mt-1">
  ...
  defp unread_message_counter(assigns) do
    ...
    <span
      :if={@count > 0}
      class="flex items-center justify-center bg-blue-500 rounded-full font-medium
      h-5 px-2 ml-auto text-xs text-white"
      >
        <%= @count %>
      </span>
    """
    ...
    socket =
      if Chat.joined?(room, current_user) do
        case Chat.create_message(room, message_params, current_user) do
          ## This was causing the reload error
          {:ok, _message} ->
